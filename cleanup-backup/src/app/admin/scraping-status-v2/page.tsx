...
export default function ScrapingStatusV2Page() {
  ...
  const fetchStats = async () => {
    try {
      const response = await fetch('/api/scraping/listings-count-v2');
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-8">
      <div className="max-w-7xl mx-auto">
        <h1 className="text-3xl font-bold mb-8">Scraping Status (v2)</h1>
        ...
        <div className="bg-white p-6 rounded-lg shadow mb-8">
          ...
          <div className="flex gap-4">
            ...
            >
              {isTriggering ? 'Starting...' : 'Start Incremental Scraping'}
            </button>
