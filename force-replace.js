...
export function LatestPosts({ posts }: LatestPostsProps) {
  console.log('🟢 LatestPosts 컴포넌트 렌더링 - 강제 교체 버전 2025-11-17!');
    ...
    <section className="space-y-6">
      ...
      <div className="space-y-6">
        {posts.map((post) => {
          ...
          console.log(\`📝 Post: \${post.id.substring(0, 8)} | title: \${title.substring(0, 30)}... | excerptLength: \${excerptLength}\`);
...
// 강제 교체
fs.writeFileSync(filePath, CORRECT_CODE, 'utf-8');
console.log(`✅ 파일 교체 완료: ${filePath}`);

// 검증
const newContent = fs.readFileSync(filePath, 'utf-8');
console.log('\n🔍 검증:');
console.log('  line-clamp-1:', newContent.includes('line-clamp-1') ? '✅' : '❌');
console.log('  mb-2:', newContent.includes('mb-2') ? '✅' : '❌');
console.log('  mt-3:', newContent.includes('mt-3') ? '✅' : '❌');
console.log('  console.log (새 버전 마커):', newContent.includes('강제 교체 버전 2025-11-17') ? '✅' : '❌');
console.log('  파일 크기:', newContent.length, 'bytes');
