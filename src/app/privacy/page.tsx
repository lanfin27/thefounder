      ...
      <div className="max-w-3xl mx-auto prose prose-gray max-w-none">
        ...
        <div className="bg-blue-50 border-l-4 border-blue-400 p-4 mb-8">
          <p className="text-sm text-blue-800">
            로브(이하 "회사")는 개인정보보호법에 따라 이용자의 개인정보 보호 및 권익을 보호하고
        ...
        <section className="mb-8">
          ...
          <div className="bg-blue-50 rounded-lg p-6">
            ...
            <ul className="space-y-1 text-sm">
              <li><strong>성명:</strong> Jay</li>
              <li><strong>직책:</strong> Manager</li>
              <li><strong>이메일:</strong> thefndrbiz@gmail.com</li>
            </ul>
          </div>
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            이 개인정보처리방침은 2025년 11월 25일부터 적용되며, 법령 및 방침에 따른 변경내용의
        ...
        <div className="mt-12 p-6 bg-gray-50 rounded-lg">
          <p className="text-sm text-gray-600">
            본 개인정보처리방침은 2025년 11월 25일부터 시행됩니다.<br />
